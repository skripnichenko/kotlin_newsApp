...
import com.example.myapplication.presentation.onboarding.Dimensions.MediumPadding2
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Row(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                if (butonState.value[0].isNotEmpty()) {
                    NewsTextButton(text = butonState.value[0], onClick = {
                        scope.launch {
                            pagerState.animateScrollToPage(page = pagerState.currentPage - 1)
                        }
                    })
                }
                NewsButton(text = butonState.value[1], onClick = {
                    scope.launch {
